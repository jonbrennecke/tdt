...
Handle<Value> V8Variant::OLEValue(const Arguments& args)
{
  ...
  || ocv->v.vt == VT_UI4 || ocv->v.vt == VT_UINT || ocv->v.vt == VT_I2) result = OLEInt32(args);
